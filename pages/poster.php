            ...
            if (!in_array($mime, $allowedTypes)) {
                ...
                try {
                    ...
                    $insert = $bdd->prepare("
                        ...
                        (user_id, contenu, image_path, date) 
                        VALUES (?, ?, ?, NOW())
                    ");
                    
                    $result = $insert->execute([
                        $_SESSION['id_u'],  // ID de l'utilisateur
                        htmlspecialchars($_POST['message']),  // Le message
                        'assets/images/uploads/' . $filename  // Le chemin de l'image
                    ]);
                    ...
                    $messages[] = [
                        'type' => 'success',
                        'text' => 'Image et message publiés avec succès!'
                    ];
