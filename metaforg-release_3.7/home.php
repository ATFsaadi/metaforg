    ...
    <div class="col-lg-6">
      ...
      <div class="create-post mb-4 mt-3">
        <div class="d-flex align-items-center mb-3">
          <div class="me-2">
          <?php
            $avatarPath = "assets/images/Profil/profil_{$_SESSION['id_u']}.png";
            if (!file_exists($avatarPath)) {
                $avatarPath = "assets/images/default_avatar.png";
            }
          ?>
          <img src="<?= $avatarPath ?>" alt="Avatar" class="post-avatar" loading="lazy">
          </div>
      ...
      <div class="post-card mb-4">
        <div class="post-header d-flex align-items-center">
          <?php
            $userAvatarPath = "assets/images/Profil/profil_{$post['user_id']}.png";
            if (!file_exists($userAvatarPath)) {
                $userAvatarPath = "assets/images/default_avatar.png";
            }
          ?>
