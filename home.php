    ...
    <div class="col-lg-6">
        ...
        <div class="story-container">
          ...
          <div class="story">
            <div class="story-avatar-wrapper avatar-border">
              <img src="assets/images/default_avatar.png" alt="Story ami <?= $i ?>" loading="lazy">
            </div>
      ...
      <div class="create-post mb-4 mt-3">
        <div class="d-flex align-items-center mb-3">
          <div class="me-2">
            <img src="assets/images/default_avatar.png" alt="Avatar" class="post-avatar" loading="lazy">
          </div>
        ...
        <div class="card mb-4">
          ...
          <div class="card-body p-2">
            ...
            <div class="friend-suggestion d-flex align-items-center mb-2">
              <img src="assets/images/default_avatar.png" alt="Avatar de <?= htmlspecialchars($user['login']) ?>" class="friend-avatar" loading="lazy">
