    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="position-relative px-4">
                <button class="scroll-btn left btn btn-sm position-absolute top-50 start-0 translate-middle-y" style="z-index: 2;" aria-label="Scroll left">◀</button>

                <div class="story-container">
                    <div class="story-create">
                        <div class="story-avatar-wrapper">
                            <img src="avatar.php?id=<?= $_SESSION['id_u'] ?>" alt="Votre avatar" loading="lazy">
...
<button
class="scroll-btn right btn btn-sm position-absolute top-50 end-0 translate-middle-y"
style="z-index: 2;"
...
<input
    ...
    placeholder="Quoi de neuf, <?= htmlspecialchars($_SESSION['login'] ?? 'utilisateur') ?> ?"
...
<div class="card-body p-2">
    ...
    <!-- Styles personnalisés pour les avatars et les noms -->
    ...
    <div class="friend-suggestion d-flex align-items-center mb-2">
        ...
        <div class="ms-2 flex-grow-1">
            <a
                href="pages/profil.php?id=<?= $user['id_u'] ?>"
                class="friend-name text-decoration-none">
                <?= htmlspecialchars($user['login']) ?>
            </a>
        </div>

        <a
            href="pages/ajouter_ami.php?id=<?= $user['id_u'] ?>"
...
container.scrollLeft += direction === 'right'
? step
: -step;
updateScrollButtons();
}, 50);
...
btnLeft.style.display = container.scrollLeft > 0
? 'inline-block'
: 'none';
btnRight.style.display = container.scrollLeft < maxScrollLeft
? 'inline-block'
: 'none';
}
