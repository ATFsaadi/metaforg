<?php
// SECTION: Calcul des messages non lus
$nb_non_lus = 0;
...
<!-- COMPOSANT: Bouton de messagerie -->
...
<!-- COMPOSANT: Panneau de messagerie -->
<div id="chatPanel">
    <div class="header">
    ...
    <div class="p-2" id="chatContent">
        <?php
        // SECTION: Affichage des conversations
        if (!isset($_SESSION['id_u'])) {
...
<script>
    // FONCTION: Basculer l'affichage du panneau
    function toggleChat() {
    ...
    // FONCTION: Défilement vers le bas
    ...
    // GESTION: Fermeture en cliquant à l'extérieur
    ...
    // INITIALISATION: Défilement au chargement
    document.addEventListener('DOMContentLoaded', function () {
        scrollToBottom();
    });

    // ACTUALISATION: Rafraîchissement automatique
    setInterval(() => {
        location.reload();
    }, 30000);
</script>
...
<style>
    ...
    /* BLOC: Icône et badge de notification */
    #chatButton i {
        font-size: 20px;
    }
    ...
    /* ANIMATION: Affichage du panneau */
    @keyframes slideIn {
        from {
            opacity: 0;
